...
const HatListingPage = () => {
  ...
  const products = [
    {
      id: 1,
      name: 'Nón Rộng Vành Màu Be',
      englishName: 'Beige Wide Brim Hat',
      sku: 'HAT2025001',
      price: '350,000₫',
    ...
    {
      id: 2,
      name: 'Nón Cấp Màu Đen',
      englishName: 'Black Cap Hat',
      sku: 'HAT2025002',
      price: '250,000₫',
    ...
    {
      id: 3,
      name: 'Nón Lưới Màu Xanh',
      englishName: 'Blue Mesh Hat',
      sku: 'HAT2025003',
      price: '300,000₫',
                ...
                {expandedSections.price && (
                  <div className="filter-section-content">
                    <div className="price-inputs">
                      ...
                      <span>-</span>
                      <input type="text" placeholder="1,000,000₫" className="price-input" />
                    </div>
                  </div>
                )}
              </div>
