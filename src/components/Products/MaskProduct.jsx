...
const MaskListingPage = () => {
  ...
  const filters = [
    { id: 'khau-trang', label: 'KHẨU TRANG' },
  ];

  const products = [
    {
      id: 1,
      name: 'Khẩu Trang Vải Cao Cấp Màu Đen',
      englishName: 'Premium Black Fabric Mask',
      sku: 'MASK2025001',
      price: '50,000₫',
      originalPrice: '100,000₫',
      discount: '-50%',
      stock: 1000,
      image: 'https://images.unsplash.com/photo-1600699750501-36ea09d32841?w=600&q=80',
      colors: [{ name: 'BLACK', value: 'black' }],
      sizes: ['S', 'M', 'L']
    },
    {
      id: 2,
      name: 'Khẩu Trang Y Tế 4 Lớp Màu Xanh',
      englishName: 'Medical Blue Mask 4 Layers',
      sku: 'MASK2025002',
      price: '30,000₫',
    ...
    {
      id: 3,
      name: 'Khẩu Trang N95 Màu Trắng',
      englishName: 'N95 White Mask',
      sku: 'MASK2025003',
      price: '100,000₫',
    ...
    {
      id: 4,
      name: 'Khẩu Trang Họa Tiết Hoa Màu Hồng',
      englishName: 'Floral Pink Mask',
      sku: 'MASK2025004',
      price: '60,000₫',
    ...
    {
      id: 5,
      name: 'Khẩu Trang Trẻ Em Màu Vàng',
      englishName: 'Kids Yellow Mask',
      sku: 'MASK2025005',
      price: '40,000₫',
                ...
                {expandedSections.price && (
                  <div className="filter-section-content">
                    <div className="price-inputs">
                      ...
                      <span>-</span>
                      <input type="text" placeholder="500,000₫" className="price-input" />
                    </div>
                  </div>
                )}
              </div>
...
export default MaskListingPage;
